...
<!--                     <ul class="nav navbar-nav">
                        ...
                        @elseif(Auth::user()->admin == 1)
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" aria-haspopup="true">
                                    Admin {{ Auth::user()->firstname}} {{Auth::user()->surname }} <span class="caret"></span>
                                </a>
        ...
        <div class="col-md-2"  id="adminMenu">
            @include('/admin/menu')  
        </div>

        <div class="col-md-2"  id="adminMenuMobile">
            @include('/admin/menuMobile')  
        </div>
